...
const uint32_t SHUNT_MICRO_OHM{2439};  ///< Shunt resistance in Micro-Ohm, e.g. 100000 is 0.1 Ohm
const uint16_t MAXIMUM_AMPS{30};          ///< Max expected amps, clamped from 1A to a max of 1022A
