...
#define GPIO_CAP0_IN 39 //Set GPIO 39(Sensor_VN) as  CAP0 Throttle adc(connected to brake)
#define GPIO_CAP1_IN 36 //Set GPIO 36(Sensor_VP) as  CAP1 PAS
...
static void mcpwm_example_config(void *arg)
{
  ...
  //mcpwm_capture_enable(MCPWM_UNIT_0, MCPWM_SELECT_CAP2, MCPWM_NEG_EDGE, 0);  //capture signal on rising edge, prescale = 0 i.e. 800,000,000 counts is equal to one second
